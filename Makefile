...
all: level01 level02 level03 level04 level05 level06 level07 level08 level09 level10 level11 level13
...
level13: src/level13.c
	$(CC) $(CFLAGS) src/level13.c -o bin/level13 -Wno-incompatible-pointer-types
